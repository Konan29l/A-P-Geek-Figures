...
console.log("proveedor:", document.getElementById("proveedorCosto"));
console.log("descripcion:", document.getElementById("descripcionCosto"));
console.log("valor:", document.getElementById("valorCosto"));
...
async function guardarCosto(btn) {
  if (btn.disabled) return; // 🚫 evita doble click
 console.log(document.getElementById("proveedorCosto"));
  console.log(document.getElementById("descripcionCosto"));
  console.log(document.getElementById("valorCosto"));
  try {
    // 🔒 bloquear botón
    btn.disabled = true;
    const textoOriginal = btn.innerHTML;
